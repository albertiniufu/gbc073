...
\begin{frame}{A hierarquia que emerge sozinha}
  ...
  \begin{columns}[T]
    \begin{column}{0.58\textwidth}
      \fotoslot{alexnet-arch.png}{6.4cm}{2.6cm}
        {AlexNet (2012): a hierarquia de características em 8 camadas — da borda ao objeto}
        {D.\ V.\ Godoy, Wikimedia Commons, CC BY 4.0}
    \end{column}
    \begin{column}{0.38\textwidth}
      \begin{itemize}\setlength{\itemsep}{0.2ex}
        \item Em reconhecimento facial, cada camada aprende um nível de
              abstração
        \item A hierarquia \emph{emerge} do treinamento — é isso que a
              palavra ``profundo'' compra
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}{Referências}
  ...
  DB (CC0); D.\ Godoy (CC BY 4.0); U.S.\ Navy (domínio público).\par}
\end{frame}
