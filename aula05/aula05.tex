...
%%
%% Compilar:  latexmk -xelatex aula05.tex   (duas passadas!)
%% ============================================================
...
\begin{frame}{As três descidas (batch, estocástica, mini-batch)}
  \begin{itemize}\setlength{\itemsep}{0.4ex}
    \item Descida de gradiente em lote: gradiente exato, caro, sem ruído.
    \item Descida estocástica (SGD): um exemplo por passo — ruído alto, escapa
          de mínimos ruins, converge devagar.
...
\begin{frame}{Momentum e descida acelerada}
  \begin{itemize}\setlength{\itemsep}{0.4ex}
    ...
    \item NAG (Nesterov): avalia o gradiente \emph{à frente}, no ponto onde a
          velocidade já levou.
